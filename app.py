...
dash_app.layout = html.Div(
    children=[html.H2('KEA BE-IT2020 Dashboard - Thilo Merk', style={
            'text-align': 'center'
        },),
            ...
            'text-align': 'center'
                ...
                children=[
                    ...
                    html.Div(className='div-for-charts bg-grey',
                            children=[html.H2('Sales by Employees'
        ),
                                dcc.Graph(id="sales_employee", figure=fig_employee)
                            ]
                    ),
                     html.Div(className='div-for-charts bg-grey',
                            children=[html.H2('Sales by Product'
        ),
                                dcc.Graph(id="sales_products", figure=fig_product)
                            ]
                    )
                ]
            )
